...
class LDAMACSLoss(nn.Module):
    ...
    def forward(self, x, target):
        ...
        # ---------- ACSL ----------
        # torch.log(1 - torch.sigmoid(output))
        # F.binary_cross_entropy_with_logits(output, index_float, reduction='none')
